                        ...
                        <div className="form-inner">
                            <div className="form-title">
                                <div className="d-flex justify-content-between align-itams-center">
                                    <h2 className="brandText">Sign Up</h2>
                            ...
                            <div className="input-wrapper">
                                ...
                                <p className="text-danger"><small>{errors.fullname?.message}</small></p>
                            </div>
                            ...
                            <div className="input-wrapper">
                                ...
                                <p className="text-danger"><small>{errors.username?.message}</small></p>
                            </div>
                            ...
                            <div className="input-wrapper">
                                ...
                                <p className="text-danger"><small>{errors.email?.message}</small></p>
                            </div>
                            <div className="input-wrapper">
